...
BIST = [
    # Gerçek BIST 100 (kullanıcı tarafından doğrulandı — 2026 Haziran)
    ...
    "ENJSA.IS","ENKAI.IS","EREGL.IS","EUPWR.IS","EUREN.IS","FENER.IS",
    "FROTO.IS","GARAN.IS","GENIL.IS","GESAN.IS","GLRMK.IS","GRSEL.IS",
    "GRTHO.IS","GSRAY.IS","GUBRF.IS","HALKB.IS","HEKTS.IS","ISCTR.IS",
    "ISMEN.IS","IZENR.IS","KCHOL.IS","KLRHO.IS","KONTR.IS","KRDMD.IS",
    "KTLEV.IS","KUYAS.IS","MAGEN.IS","MAVI.IS","MGROS.IS","MIATK.IS",
    "MPARK.IS","OBAMS.IS","ODAS.IS","OTKAR.IS","OYAKC.IS","PAHOL.IS",
    "PASEU.IS","PATEK.IS","PETKM.IS","PGSUS.IS","PSGYO.IS","QUAGR.IS",
    "RALYH.IS","REEDR.IS","SAHOL.IS","SARKY.IS","SASA.IS","SISE.IS",
    "SKBNK.IS","SOKM.IS","TABGD.IS","TAVHL.IS","TCELL.IS","THYAO.IS",
    "TKFEN.IS","TOASO.IS","TRALT.IS","TRENJ.IS","TRMET.IS","TSKB.IS",
    "TTKOM.IS","TUKAS.IS","TUPRS.IS","TUREX.IS","TURSG.IS","ULKER.IS",
